...
export default function () {
    ...
    let resManifesto = http.get('http://192.168.100.111:8080/videos/lol/manifesto.mpd');
    ...
    for (let i = 1; i <= 10; i++) {
        ...
        let pedaco = `slice_4_${i}.m4s`;

        let resChunk = http.get(`http://192.168.100.111:8080/videos/lol/${pedaco}`);
